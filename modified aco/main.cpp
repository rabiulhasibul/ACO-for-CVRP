...
//            cout<<"Paht cost "<<cost<<endl;
//            for(int x=0; x<solution[i].size(); x++)
//                cout<<solution[indx][x]<<" ";
//            cout<<endl<<endl;
        ...
        Tao_for_best_sol = (1.0-RHO)*Tao_for_best_sol+1/dist;
...
//            cout<<endl<<endl;
                ...
                V.push_back(make_pair(dist,Vj));

                cout<<"Paht cost Guide initial city from 0 to "<<Vj<<", "<<dist<<endl;
                for(int x=0; x<solution[indx].size(); x++)
                    cout<<solution[indx][x]<<" ";
                cout<<endl<<endl;
            }
            ...
            for(int i=0; i<row; i++)
            {
                for(int j=0; j<col; j++)
                {
                    probability[i][j]=((heuristic[i][j]*pheromone[i][j])/sum)*temp[j]/sum_of_V;
